...
import 'package:homei/features/project_details/data/datasources/remote_data_source.dart';
...
class ProjectDetailsRepository {
  ...
  //     ProjectDetailsModel projectModel = await remoteDataSource!.fetchProject();
  //     return projectModel; // Map the model to the entity
  //   } catch (error) {
